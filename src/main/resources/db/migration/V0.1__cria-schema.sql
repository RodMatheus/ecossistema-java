...
CREATE TABLE comum.operacao_log_auditoria (
    id smallint generated by default as identity primary key,
    descricao varchar(50) not null);

CREATE TABLE comum.log_auditoria (
...
ALTER TABLE comum.log_auditoria
    ADD CONSTRAINT pk_log_auditoria_operacao
    FOREIGN KEY (operacao) REFERENCES comum.operacao_log_auditoria(id);
